    ...
    create: function() {
        ...
        this.socket.on('playerHit', function(id) {
            if (id == self.socket.id) {
                ...
                self.otherPlayers.getChildren()[findOtherPlayerIndex(self.otherPlayers.getChildren(), id)].hp.decrease(5);
            }
        })
...
var GameOver = new Phaser.Class({
    ...
    create: function() {
        ...
        this.add.text(400, 450, '- Click to start restart -', { font: '16px D2Coding', fill: '#00ff00' });
