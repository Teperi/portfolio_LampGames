...
$localfile = fopen('/var/www/html/savenews/' . ($today - 1) . '_list_tig.html', 'w');
...
$html = file_get_html('/var/www/html/savenews/' . ($today - 1) . '_list_tig.html');
$linklist;
...
// 데이터가 저장될 경로 설정
$folder = '/var/www/html/savenews/tig/' . ($today - 1);
